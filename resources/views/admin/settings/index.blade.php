                ...
                <div id="general" class="tab-content space-y-6 active">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-2">
                                <label class="text-sm font-semibold text-gray-700">Pincode / Zip Code</label>
                                <input type="text" data-key="store_pincode" class="setting-input w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all outline-none" placeholder="e.g. 135001">
                            </div>
                        </div>
                    </div>
                </div>
